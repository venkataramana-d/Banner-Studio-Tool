...
export async function getEvents() { return (await impl()).getEvents(); }
export async function recordEvent(input) { return (await impl()).recordEvent(input); }
export async function getBlackouts() { return (await impl()).getBlackouts(); }
export async function createBlackout(input) { return (await impl()).createBlackout(input); }
export async function deleteBlackout(id) { return (await impl()).deleteBlackout(id); }
